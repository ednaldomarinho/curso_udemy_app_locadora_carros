...
class ModeloController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //get() -> cria um obj de consulta +get() =  collection
        //all() -> cria um obj de consulta  = collection
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //remove o arquivo antigo caso o novo seja enviado
        if ($request->file('imagem')) {
         ...
         //preencher o objeto $modelo com o request
